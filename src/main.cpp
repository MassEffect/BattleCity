...
int main(int argc, char** argv)
{
...

	{
        ...
        {
            std::cerr << "Can't create the shader program: " << "DefaultShader" << std::endl;
            return -1;
        };
        ...
        {
            std::cerr << "Can't create the shader program: " << "SpriteShader" << std::endl;
            return -1;
        };
        ...
        auto pSprite = resourceManager.loadSprite("NewSprite", "defaultTextureAtlas", "SpriteShader", 100, 100, "bottomRightBlock");
        pSprite -> setPosition(glm::vec2(300, 100));

        auto pAnimatedSprite = resourceManager.loadAnimatedSprite("NewAnimatedSprite", "defaultTextureAtlas", "SpriteShader", 100, 100, "bottomRightBlock");
