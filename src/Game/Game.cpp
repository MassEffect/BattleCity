...
bool Game::init()
{
        ...
        {
            std::cerr << "Can't find shader's programm: " << "spriteShader" << std::endl;
            return false;
        };
        ...
        auto pAnimatedSprite = ResourceManager::loadAnimatedSprite("NewAnimatedSprite", "mapTextureAtlas", "spriteShader", 100, 100, "bottomRightBlock");
