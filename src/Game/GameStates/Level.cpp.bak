...
Level::Level(const std::vector<std::string>& levelDescription)
{
    ...
    m_playerRespawn_1 = {BLOCK_SIZE * (m_widthBlocks / 2.0f - 1.5f), BLOCK_SIZE / 2.0f};
    m_playerRespawn_2 = {BLOCK_SIZE * (m_widthBlocks / 2.0f + 2.5f), BLOCK_SIZE / 2.0f};
    m_enemyRespawn_1  = {BLOCK_SIZE                                , m_heightBlocks * BLOCK_SIZE - BLOCK_SIZE / 2.0f};
    m_enemyRespawn_2  = {BLOCK_SIZE * (m_widthBlocks / 2.0f + 0.5f), m_heightBlocks * BLOCK_SIZE - BLOCK_SIZE / 2.0f};
    m_enemyRespawn_3  = {BLOCK_SIZE * m_widthBlocks                , m_heightBlocks * BLOCK_SIZE - BLOCK_SIZE / 2.0f};
    ...
    //right border
    m_levelObjects.emplace_back(std::make_shared<Border>(glm::vec2((m_widthBlocks + 1) *  BLOCK_SIZE, 0.0f), glm::vec2(BLOCK_SIZE * 2.0f, (m_heightBlocks + 1) * BLOCK_SIZE), 0.0f, 0.0f));
};
